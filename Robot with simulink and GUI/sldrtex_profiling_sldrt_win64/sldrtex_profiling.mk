...
MAKECMD         = "D:/MATLAB/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := sldrtex_profiling
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c sldrtex_profiling_data.c sldrtex_profiling_tgtconn.c
MAKEFILE             := sldrtex_profiling.mk
...
SLDRTDIR             := D:/MATLAB/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
#
MODELLIB                  := sldrtex_profilinglib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := sldrtex_profiling_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/ADMINI~1.SC-/Desktop/ROBOTW~1;$(MATLAB_ROOT)/simulink/include/sf_runtime;C:/Users/ADMINI~1.SC-/Desktop/ROBOTW~1/sldrtex_profiling_sldrt_win64;$(MATLAB_ROOT)/toolbox/sldrt/sldrtexamples;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
