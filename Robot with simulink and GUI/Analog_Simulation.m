function varargout = Analog_Simulation(varargin)
% ANALOG_SIMULATION MATLAB code for Analog_Simulation.fig
%      ANALOG_SIMULATION, by itself, creates a new ANALOG_SIMULATION or raises the existing
%      singleton*.
%
%      H = ANALOG_SIMULATION returns the handle to a new ANALOG_SIMULATION or the handle to
%      the existing singleton*.
%
%      ANALOG_SIMULATION('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ANALOG_SIMULATION.M with the given input arguments.
%
%      ANALOG_SIMULATION('Property','Value',...) creates a new ANALOG_SIMULATION or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Analog_Simulation_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Analog_Simulation_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Analog_Simulation

% Last Modified by GUIDE v2.5 04-Mar-2019 01:33:46

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Analog_Simulation_OpeningFcn, ...
                   'gui_OutputFcn',  @Analog_Simulation_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Analog_Simulation is made visible.
function Analog_Simulation_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Analog_Simulation (see VARARGIN)

% Choose default command line output for Analog_Simulation
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Analog_Simulation wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Analog_Simulation_OutputFcn(hObject, eventdata, handles) 
