...
*                                                                         octet @ lowest memory address)
*
*           (3) '__BIG_ENDIAN' is a RealView compiler #define that reflects the '--endian' option, 
*               indicating the data word-memory order :
*
*               (a)   Defined for big    endian word-memory order
*               (b) Undefined for little endian word-memory order
*********************************************************************************************************
*/
...
#ifdef __BIG_ENDIAN                                             /* Defines CPU data    word-memory order (see Note #2). */
...
/*
*********************************************************************************************************
*                     ARM CORTEX-R4 PROGRAM STATUS REGISTER BIT & BIT-FIELDS DEFINES
*********************************************************************************************************
*/
...
/*
*********************************************************************************************************
*                              ARM CORTEX-R4 FLOATING POINT UNIT BIT DEFINES
*********************************************************************************************************
*/
...
/*
*********************************************************************************************************
*                          ARM CORTEX-R4 EVENTS AND PERFORMANCE MONITOR
*
...
/*
*********************************************************************************************************
*                             ARM CORTEX-R4 MEMORY PROTECTION UNIT DEFINES
*********************************************************************************************************
*/

#define  CPU_ARM_MPU_ACCESS_REG_BIT_B                           DEF_BIT_00
#define  CPU_ARM_MPU_ACCESS_REG_BIT_C                           DEF_BIT_01
#define  CPU_ARM_MPU_ACCESS_REG_BIT_TEX_0                       DEF_BIT_03
#define  CPU_ARM_MPU_ACCESS_REG_BIT_TEX_1                       DEF_BIT_04
#define  CPU_ARM_MPU_ACCESS_REG_BIT_TEX_2                       DEF_BIT_05

                                                                /* ------------- ACCESS PERMISSION DEFINES ------------ */
#define  CPU_ARM_MPU_ACCESS_PERM_NO_ACCESS                      DEF_BIT_MASK(0u, 8u)
#define  CPU_ARM_MPU_ACCESS_PERM_PRIV_FULL                      DEF_BIT_MASK(1u, 8u)
#define  CPU_ARM_MPU_ACCESS_PERM_USER_RD                        DEF_BIT_MASK(2u, 8u)
#define  CPU_ARM_MPU_ACCESS_PERM_USER_FULL                      DEF_BIT_MASK(3u, 8u)
#define  CPU_ARM_MPU_ACCESS_PERM_RSVD_00                        DEF_BIT_MASK(0u, 8u)
#define  CPU_ARM_MPU_ACCESS_PERM_PRIV_RD                        DEF_BIT_MASK(5u, 8u)
#define  CPU_ARM_MPU_ACCESS_PERM_PRIV_USER_RD                   DEF_BIT_MASK(6u, 8u)
#define  CPU_ARM_MPU_ACCESS_PERM_RSVD_01                        DEF_BIT_MASK(7u, 8u)

#define  CPU_ARM_MPU_ACCESS_SHARE                               DEF_BIT_02
#define  CPU_ARM_MPU_ACCESS_EXECUTE_NEVER                       DEF_BIT_12

                                                                /* ----------- MEMORY ACCESS TYPE ATTRIBUTES ---------- */
#define  CPU_ARM_MPU_ACCESS_TYPE_STRONG_ORDERED                 DEF_BIT_NONE
#define  CPU_ARM_MPU_ACCESS_TYPE_DEV_SHARED                     (                                                                  CPU_ARM_MPU_ACCESS_REG_BIT_B)
#define  CPU_ARM_MPU_ACCESS_TYPE_DEV                            (CPU_ARM_MPU_ACCESS_REG_BIT_TEX_1                                                              )

#define  CPU_ARM_MPU_ACCESS_TYPE_NORMAL_OI_WT                   (                                   CPU_ARM_MPU_ACCESS_REG_BIT_C                               )
#define  CPU_ARM_MPU_ACCESS_TYPE_NORMAL_OI_WB                   (                                   CPU_ARM_MPU_ACCESS_REG_BIT_C | CPU_ARM_MPU_ACCESS_REG_BIT_B)
#define  CPU_ARM_MPU_ACCESS_TYPE_NORMAL_OI_NONE                 (CPU_ARM_MPU_ACCESS_REG_BIT_TEX_0                                                              )
#define  CPU_ARM_MPU_ACCESS_TYPE_NORMAL_OI_WBA                  (CPU_ARM_MPU_ACCESS_REG_BIT_TEX_0 | CPU_ARM_MPU_ACCESS_REG_BIT_C | CPU_ARM_MPU_ACCESS_REG_BIT_B)

#define  CPU_ARM_MPU_ACCESS_TYPE_NORMAL_CACHE(inner, outer)     (CPU_ARM_MPU_ACCESS_REG_BIT_TEX_2 | ((inner << 3u)) | (outer))
#define  CPU_ARM_MPU_ACCESS_TYPE_NORMAL_CACHE_OPT_NONE           DEF_BIT_NONE
#define  CPU_ARM_MPU_ACCESS_TYPE_NORMAL_CACHE_OPT_WBA            DEF_BIT_00
#define  CPU_ARM_MPU_ACCESS_TYPE_NORMAL_CACHE_OPT_WT             DEF_BIT_01
#define  CPU_ARM_MPU_ACCESS_TYPE_NORMAL_CACHE_OPT_WB            (DEF_BIT_00 | DEF_BIT_01)
...
*                                         FUNCTION PROTOTYPES
*
* Note(s) : (1) CPU_PMU_xxx() functions are intended to manage the Event & Performanace Monitor unit (PMU).
*********************************************************************************************************
*/
...
CPU_BOOLEAN  CPU_MPU_RegionEn   (CPU_INT08U  nbr,
                                 CPU_ADDR    addr,
                                 CPU_INT08U  sub_reg_en,
                                 CPU_INT32U  size,
                                 CPU_INT32U  acess_attrib);
void         CPU_MPU_RegionDis  (CPU_INT08U  nbr);
