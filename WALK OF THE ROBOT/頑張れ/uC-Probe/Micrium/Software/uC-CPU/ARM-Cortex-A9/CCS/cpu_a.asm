...
;********************************************************************************************************
   ...
   .global  CPU_MMU_En
   .global  CPU_MMU_Dis
   .global  CPU_MPU_RegionEn
   .global  CPU_MPU_RegionDis
...
CPU_ARM_CTRL_INT_DIS    .equ    0x000000C0                      ; Disable both FIQ & IRQ
CPU_ARM_CTRL_FIQ_DIS    .equ    0x00000040                      ; Disable FIQ.
CPU_ARM_CTRL_IRQ_DIS    .equ    0x00000080                      ; Disable IRQ.
...
; Caller(s)   : Application.
;              
; Note(s)     : (2) 'R1' is used to calculate the value to be written in the CNTENS register.
;********************************************************************************************************
