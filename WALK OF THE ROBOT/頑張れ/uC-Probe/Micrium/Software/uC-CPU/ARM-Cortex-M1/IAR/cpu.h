...
#define  CPU_REG_NVIC_AUXCTRL        (*((CPU_REG32 *)(0xE000E008)))             /* Auxiliary Control Reg.               */
...
#define  CPU_REG_NVIC_SETEN          (*((CPU_REG32 *)(0xE000E100)))             /* IRQ Set En Reg.                      */
#define  CPU_REG_NVIC_CLREN          (*((CPU_REG32 *)(0xE000E180)))             /* IRQ Clr En Reg.                      */
#define  CPU_REG_NVIC_SETPEND        (*((CPU_REG32 *)(0xE000E200)))             /* IRQ Set Pending Reg.                 */
#define  CPU_REG_NVIC_CLRPEND        (*((CPU_REG32 *)(0xE000E280)))             /* IRQ Clr Pending Reg.                 */
...
*/
                                                                ...
                                                                /* -------------- AUXILIARY CTRL REG BITS ------------- */
#define  CPU_REG_NVIC_AUXCTRL_ITCMUAEN            0x00000010
#define  CPU_REG_NVIC_AUXCTRL_ITCMLAEN            0x00000008
